                ...
                <div class="form-group row mx-auto d-flex flex-column">
                    ...
                    <div class="form-floating">
                        ...
                        <input type="username" id="UsernameRegister" name="user_name"
                            class="form-control icon2 rounded mt-2" placeholder=" Username" value="{{$user->user_name }}">
                    ...
                    <div class="form-floating">
                        <input type="text" id="EmailRegister" name="email"
                            class="form-control icon rounded  mt-2" placeholder=" Email" value="{{$user->email }}">
                    ...
                    <div class="form-floating">
                        <input type="date" id="BirthDateRegister" name="birth_date"
                            class="form-control icon rounded mt-2" placeholder="BirthDate" value="{{$user->birth_date }}">
